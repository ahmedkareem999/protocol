    ...
    */
        ...
        returns (bool err, string errMsg)
    {
        ...
        if (!module.riskmgmt.isTakePermitted(
                module.datafeed.getOrderPrice(order.buyAsset, order.buyQuantity, order.sellQuantity), // TODO check: Buying what is being sold and selling what is being bought
